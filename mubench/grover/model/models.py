...
class GroverFpGeneration(nn.Module):
    ...
    It loads the pre-trained model11 and produce the fingerprints for input molecules.
    """
    def __init__(self, args):
        """
        Init function.
        ...
        self.fingerprint_source = args.embedding_output_type
...
class GroverFinetuneTask(nn.Module):
    ...
    def get_loss_func(args):
        def loss_func(preds, targets,
            ...
            # TODO: Here, should we need to involve the model11 status? Using len(preds) is just a hack.
