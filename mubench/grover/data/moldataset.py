...
from .molfeaturegenerator import get_features_generator
...
class MoleculeDatapoint:
    ...
    def __init__(self,
        ...
        Parameters
        ----------
        line: A list of strings generated by separating a line in a data CSV file by comma.
        config: Arguments.
        features: A numpy array containing additional features (ex. Morgan fingerprint).
        use_compound_names: Whether the data CSV includes the compound name on each line.
        """
        self.features_generator = None
        if config is not None:
            if hasattr(config, "features_generator"):
                self.features_generator = config.features_generator
            ...
            for fg in self.features_generator:
                ...
                if mol is not None and mol.GetNumHeavyAtoms() > 0:
                    if fg in ['morgan', 'morgan_count']:
                        self.features.extend(features_generator(mol, num_bits=config.num_bits))
                    else:
...
class MoleculeDataset(Dataset):
    ...
    def compound_names(self) -> Union[List[str], None]:
        """
    ...
    def features(self) -> Union[List[np.ndarray], None]:
        """
    ...
    def __getitem__(self, idx) -> Union[MoleculeDatapoint, List[MoleculeDatapoint]]:
        ...
        :param idx: An index (int) or a slice object.
