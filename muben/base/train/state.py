"""
Modified from transformers.trainer_callback:
...
class TrainerState:
    ...
    n_eval_no_improve: int = 0,  # counts how many evaluation steps in total the model performance has not improved
    ...
    def save_to_json(self, json_path: str):
        ...
        json_string = json.dumps(
            {k: v for k, v in asdict(self).items() if 'timer' not in k}, indent=2, sort_keys=True
        ) + "\n"
