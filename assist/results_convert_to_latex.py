...
class Arguments:
    ...
    filename_prefix: Optional[str] = field(
        default="tb3.result.dataset",
        metadata={"help": "Prefix of the file names."}
    )
    label_prefix: Optional[str] = field(
        default="apptb:result.dataset",
        metadata={"help": "Prefix of the table labels."}
    )
...
def main(args: Arguments):
    ...
    for dataset in CLASSIFICATION_DATASET:
        ...
        data_df.to_latex(op.join(args.output_dir, f"{args.filename_prefix}.{dataset}.tex"),
